...
private:
    ...
    void createSyncObjects() {
        ...
        fenceInfo.flags = VK_FENCE_CREATE_SIGNALED_BIT; // this is needed because we don't need to wait for the first frame when the app starts
    ...
    void createGraphicsPipeline() {
        ...
        pipelineInfo.basePipelineHandle = VK_NULL_HANDLE; // optional these are only used when deriving a new pipeline from this one
